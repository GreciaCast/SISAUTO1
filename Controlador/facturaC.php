<?php
	...
	if($bandera == "factura"){
		...
		$numeroFCredito = $_POST["numFCredito"];
		$numeroFConsumidor = $_POST["numFConsumidor"];
		$sql = "INSERT INTO numerofactura (numeroInicial_numF,tipo_numF) VALUES ('$numeroFCredito',1)";// 1 para credito fiscal
